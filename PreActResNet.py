...
class PreActRes_block(nn.Module):
    ...
    def forward(self, x):
        f = self.conv1(self.relu(self.bn1(x)))
        f = self.conv2(self.relu(self.bn2(f)))
...
class PreActResnet32(nn.Module):
    def __init__(self):
        ...
        self.stack2 = nn.Sequential(
            PreActRes_block(16, 32, downsampling=True),
            PreActRes_block(32, 32),
            PreActRes_block(32, 32),
            PreActRes_block(32, 32),
            PreActRes_block(32, 32)
        )
        self.stack3 = nn.Sequential(
            PreActRes_block(32, 64, downsampling=True),
            PreActRes_block(64, 64),
            PreActRes_block(64, 64),
            PreActRes_block(64, 64),
            PreActRes_block(64, 64)
        )
